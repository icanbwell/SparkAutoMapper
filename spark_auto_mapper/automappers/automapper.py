...
class AutoMapper(AutoMapperContainer):
    ...
    def __init__(
        ...
        skip_if_column_does_not_exist: Optional[str] = None,
        ...
        :param skip_if_column_does_not_exist: skip creating the record if the column does not exist in the source.
        ...
        self.skip_if_column_does_not_exist: Optional[str] = skip_if_column_does_not_exist
    ...
    def complex(self, entity: AutoMapperDataTypeComplexBase) -> "AutoMapper":
        ...
        resource_mapper: AutoMapperWithComplex = AutoMapperWithComplex(
            ...
            skip_if_column_does_not_exist=self.skip_if_column_does_not_exist,
