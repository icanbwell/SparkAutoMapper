...
class AutoMapperContainer(AutoMapperBase):
    ...
    def generate_mappers(self, kwargs: Dict[str, AutoMapperDataTypeBase]) -> None:
    ...
    def transform(self, df: DataFrame) -> DataFrame:
        # TODO: this is copied from base class and the difference is we call the self.mappers[-1] to do the work
