...
def test_auto_mapper_datatype_literal(spark_session: SparkSession) -> None:
    ...
    assert_compare_expressions(sql_expressions["dst2"], lit(None).alias("dst2"))
    assert_compare_expressions(sql_expressions["dst3"], lit("").alias("dst3"))
    assert_compare_expressions(sql_expressions["dst4"], lit("literal").alias("dst4"))
    assert_compare_expressions(sql_expressions["dst5"], lit(1234).alias("dst5"))
    assert_compare_expressions(sql_expressions["dst6"], lit(0).alias("dst6"))
